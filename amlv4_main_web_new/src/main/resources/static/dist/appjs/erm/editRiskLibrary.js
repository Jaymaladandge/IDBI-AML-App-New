...
//            }).get().join(', ');
	...
	document.getElementById('load').style.visibility = "visible";
		...
		var controlAssessmentDrop = $('#controlAssessmentDrop').val();
		
		if(controlAssessmentDrop != '')
		{
	...
	var rasString = "{\n" +
		...
		"    \"sendNotification\":\"" + notificationFlg + "\",\n" +
...
//									});
			...
			var contrlFreq = $("#controlAssessmentFreq").find(":selected").text();
			 //$("#controlAssessmentFreq2").prop("selectedIndex", 0).val();
			//$('#controlAssessmentFreq2 option:contains('+contrlFreq+')').prop('selected',true);
			$("#controlAssessmentFreq2").val(contrlFreq);
			stepper.next();
			$(window).scrollTop(1);
