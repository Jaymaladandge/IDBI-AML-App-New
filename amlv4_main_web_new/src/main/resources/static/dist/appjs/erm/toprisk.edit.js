				...
				obj.deptKriList
					.forEach(function(listItems) {
						...
						var thresholdTab = '<table>'
							+ threshold + '</table>';
						trDiv = ('<tr class="mainTab" id="tr' + kriId + deptId + '"><td>'
							+ kriId
							+ '</td><td> '
							+ kriName
							+ '</td><td>'
...
function updateCummWtbyDept(deptId) {
