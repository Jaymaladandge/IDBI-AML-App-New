...
public class RulePriorityExcelExport {
	...
	public RulePriorityExcelExport(OmsAlertMasterDto alertDto) {
	...
	// this method is for common header with User Details
		...
		private void writeHeaderLine() {
			...
			sheet.addMergedRegion(new CellRangeAddress(13, 14, 10, 10));
		...
		private void writeDataLines() { 
			...
			// Open _Red Color 
					...
					// Open _Orange Color 
							...
							// Open Blue Color 
							XSSFCellStyle styleB = workbook.createCellStyle();
							XSSFFont fontB = workbook.createFont();
							fontB.setBold(true);
							fontB.setFontName("Times New Roman");
							fontB.setFontHeight(14);
			...
			int rowCount = 15;
			 ...
			 // createCell(row, columnCount++, srNo, style);
			  ...
			  createCell(row, columnCount++, alertObj.getHighOpenCount(), styleR);
			  createCell(row, columnCount++, alertObj.getHighCloseCount(), styleG); 
			  createCell(row, columnCount++, alertObj.getHighEscalateCount(), styleY); 
			  createCell(row, columnCount++, alertObj.getMediumOpenCount(), styleR);
			  createCell(row, columnCount++, alertObj.getMediumCloseCount(), styleG);
			  createCell(row, columnCount++, alertObj.getMediumEscalateCount(), styleY);
			  createCell(row, columnCount++, alertObj.getLowOpenCount(), styleR); 
			  createCell(row, columnCount++, alertObj.getLowCloseCount(), styleG);
			  createCell(row, columnCount++, alertObj.getLowEscalateCount(), styleY);
			  createCell(row, columnCount++, alertObj.getTotalCount(), styleB);
		...
		// this method is for common header with User Details
			...
			private void writeHeaderLineRegion() {
				...
				cell5.setCellValue("Total");
				sheet.addMergedRegion(new CellRangeAddress(13, 14, 11, 11));
				cell5.setCellStyle(styleH);
