...
public class BranchwiseAgeAnalysisExcelExport {
	...
	public BranchwiseAgeAnalysisExcelExport(OmsAlertMasterDto alertDto) {
	...
	private void writeHeaderLine() {
		...
		createCell(row, 3, "Branch", style);
		createCell(row, 4, "Rule Id", style);
		createCell(row, 5, "Exception Description", style);
		createCell(row, 6, "Classification", style);
		createCell(row, 7, "Risk Severity", style);
		createCell(row, 8, "1 Day", style);
		createCell(row, 9, ">1 Day & <= 1 Week", style);
		createCell(row, 10, ">1 Week & <= 2 Week", style);
	...
	private void writeDataLines() {
		...
		for (OmsAlertMasterDto alertObj : alertDto.getAlertList()) {
			...
			createCell(row, columnCount++, alertObj.getRegion(), styleName);
			createCell(row, columnCount++, alertObj.getBranchName(), style);
			createCell(row, columnCount++, alertObj.getRuleId(), style);
			createCell(row, columnCount++, alertObj.getRuleDesc(), style);
			createCell(row, columnCount++, alertObj.getRuleClassification(), style);
			createCell(row, columnCount++, alertObj.getRuleRisk(), style);
			createCell(row, columnCount++, alertObj.getOneDayCountTotal(), style);
			createCell(row, columnCount++, alertObj.getOneWeekCountTotal(), style);
			createCell(row, columnCount++, alertObj.getGtOneWeekltTwoWeekTotal(), style);
