...
public class VgdZoneWiseReportExcel {
	...
	public VgdZoneWiseReportExcel(OmsAlertMasterDto alertDto) {
	...
	// this method is for common header with User Details
		private void writeCommonHeaderLine(UserDto userDto) {
			try {
				sheet = workbook.createSheet("Vgd Report");
				...
				cell2.setCellValue("VGD ZONE WISE REPORT");
				...
				String sDate = "02/02/2023";
				String eDate = "02/02/2023";
		...
		private void writeHeaderLine() {
			 ...
			 * style.setBorderTop(BorderStyle.THIN);
			 * style.setTopBorderColor(IndexedColors.BLACK.getIndex());
			 * style.setWrapText(true); createCell(row, 0, "Tran Id", style);
			 * createCell(row, 1, "Tran Date", style); createCell(row, 2, "Account NO",
			 * style); createCell(row, 3, "Tran Amount", style); createCell(row, 4,
			 * "Alert Id", style); createCell(row, 5, "Customer Id", style); createCell(row,
			 * 6, "Account Name", style); createCell(row, 7, "Rule Id", style);
			 * createCell(row, 8, "Rule Description", style); createCell(row, 9,
			 * "Part Tran Type", style); createCell(row, 10, "Branch Id", style);
			 * createCell(row, 11, "Tran Particular", style);
			 */
			...
			cell.setCellStyle(style);
			cell.setCellValue("TRAN ID");

			XSSFCell cell1 = headerRow.createCell(1);
			cell1.setCellValue("TRAN DATE");
			...
			cell3.setCellValue("TRAN AMOUNT");
			cell3.setCellStyle(style);

			XSSFCell cell4 = headerRow.createCell(4);
			cell4.setCellValue("ALERT ID");
		...
		private void writeDataLines() {
			...
			// style.setWrapText(true);
			int srNo = 1;
			for (OmsAlertMasterDto alertObj : alertDto.getOmsAlerData()) {
				XSSFRow row = sheet.createRow(rowCount++);
				int columnCount = 0;

				
				/*
				 * createCell(row, columnCount++, alertObj.getTranId(), style); createCell(row,
				 * columnCount++, alertObj.getTranDate(), styleName); createCell(row,
				 * columnCount++, alertObj.getCustAcid(), style); createCell(row, columnCount++,
				 * alertObj.getTranAmt(), style); createCell(row, columnCount++,
				 * alertObj.getAlertId(), style); createCell(row, columnCount++,
				 * alertObj.getCustId(), style); createCell(row, columnCount++,
				 * alertObj.getAcctName(), style); createCell(row, columnCount++,
				 * alertObj.getRuleId(), style); createCell(row, columnCount++,
				 * alertObj.getRuleDesc(), style); createCell(row, columnCount++,
				 * alertObj.getPartTranType(), style); createCell(row, columnCount++,
				 * alertObj.getBranchId(), style); createCell(row, columnCount++,
				 * alertObj.getTranParticular(), style);
				 */
				
				XSSFCell cell0 = row.createCell(columnCount++);
				cell0.setCellStyle(style);
				cell0.setCellValue(alertObj.getTranId());
				
				XSSFCell cell1 = row.createCell(columnCount++);
				cell1.setCellStyle(style);
				cell1.setCellValue(alertObj.getTranDate());
				
				XSSFCell cell2 = row.createCell(columnCount++);
				cell2.setCellStyle(style);
				cell2.setCellValue(alertObj.getCustAcid());
				
				XSSFCell cell3= row.createCell(columnCount++);
				cell3.setCellStyle(style);
				cell3.setCellValue(alertObj.getTranAmt());
				
				XSSFCell cell4= row.createCell(columnCount++);
				cell4.setCellStyle(style);
				cell4.setCellValue(alertObj.getAlertId());
				
				XSSFCell cell5 = row.createCell(columnCount++);
				cell5.setCellStyle(style);
				cell5.setCellValue(alertObj.getCustId());
				
				XSSFCell cell6 = row.createCell(columnCount++);
				cell6.setCellStyle(style);
				cell6.setCellValue(alertObj.getAcctName());
				
				XSSFCell cell7 = row.createCell(columnCount++);
				cell7.setCellStyle(style);
				cell7.setCellValue(alertObj.getRuleId());
				
				XSSFCell cell8 = row.createCell(columnCount++);
				cell8.setCellStyle(style);
				cell8.setCellValue(alertObj.getRuleDesc());
				
				XSSFCell cell9 = row.createCell(columnCount++);
				cell9.setCellStyle(style);
				cell9.setCellValue(alertObj.getPartTranType());
				
				XSSFCell cell10 = row.createCell(columnCount++);
				cell10.setCellStyle(style);
				cell10.setCellValue(alertObj.getBranchId());
				
				XSSFCell cell11 = row.createCell(columnCount++);
				cell11.setCellStyle(style);
				cell11.setCellValue(alertObj.getTranParticular());
				...
				/*
				 * cell.setCellValue(alertObj.getTranDate());
				 * cell.setCellValue(alertObj.getCustAcid());
				 * cell.setCellValue(alertObj.getTranAmt());
				 * cell.setCellValue(alertObj.getAlertId());
				 * cell.setCellValue(alertObj.getCustId());
				 * cell.setCellValue(alertObj.getAcctName());
				 * cell.setCellValue(alertObj.getRuleId());
				 * cell.setCellValue(alertObj.getRuleDesc());
				 * cell.setCellValue(alertObj.getPartTranType());
				 * cell.setCellValue(alertObj.getBranchId());
				 * cell.setCellValue(alertObj.getTranParticular());
				 */
