...
public class AlertRiskwiseExcelReport {
	...
	public AlertRiskwiseExcelReport(OmsAlertMasterDto alertDto) {
	...
	private void writeCommonHeaderLine(UserDto userDto) {
		try {
			...
			cell2.setCellValue("RISK WISE ALERT COUNT REPORT");
	...
	private void writeHeaderLine() {
		...
		createCell(row, 5, "Rule Risk Type", style);
		createCell(row, 6, "Total Count", style);
		createCell(row, 7, "Open Count", style);
		createCell(row, 8, "Close Count", style);
