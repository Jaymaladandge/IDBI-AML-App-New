...
public class AgeingReportExport {
	...
	private void writeCommonHeaderLine(AlertPendencyReportDto agingReportExportDto) {
		try {
	...
	public void agingReportExport(HttpServletResponse response, AlertPendencyReportDto agingreportDto) throws IOException {
