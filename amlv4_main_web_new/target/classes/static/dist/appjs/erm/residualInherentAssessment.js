...
$("#createRA").click(function() {
	...
	// Make Control Assessment JSON 
//	var programming = $("input[name='checkboxOffice']:checked").map(function() {
//		return this.value;
//	}).get().join(', ');
//	
	
	var programming = $('#raStmtId').val();
	var overRide = null;
	...
	var controlString = "{\n" +
		...
		"    \"controlAssessmentValue\":\"" + $('#controlAssessmentDrop').find(":selected").text().toUpperCase().trim() + "\",\n" +
					...
					var jsonResponse = JSON
										...
										//		});
											...
											$('#matrixTable').DataTable()
											 ...
											 $("#overRidejustification").removeAttr('readonly');
											 $("#justification").removeAttr('readonly');
											 $("#compensating").removeAttr('readonly');
											 //improvementAreas
											  $("#improvementAreas").removeAttr('readonly');
										},
										error : function(xhr, status, error) {
											console.log(xhr);
											toastr
