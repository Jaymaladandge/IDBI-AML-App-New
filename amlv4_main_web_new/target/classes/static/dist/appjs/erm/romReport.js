	...
	if (validFlg) {
		...
		$.ajax({
			...
			success: function(response) {
				...
				$(".romReportTable > #tbodyR").empty();
				$('#romReportTable').dataTable().fnClearTable();
				$('#romReportTable').DataTable().destroy();
				dataList.forEach(function(items) {
					...
					$("<tr role='row' class='odd' id='row_id'><td class='sorting_1'>"
						...
						+ items.ruleTat
						+ "</td><td><span name='primaryLossEvent' value='" + items.ruleCat + "' class='textCapitalize'>"
						+ items.ruleCat
						+ "</td><td><span name='primaryLossEvent' value='" + items.ruleSeverity + "' class='textCapitalize'>"
						+ items.ruleSeverity
						+ "</td><td><span name='primaryLossEvent' value='" + items.custId + "' class='textCapitalize'>"
						+ items.custId
						+ "</td><td><span name='primaryLossEvent' value='" + items.acctNum + "' class='textCapitalize'>"
						+ items.acctNum
						+ "</td><td><span name='primaryLossEvent' value='" + items.name + "' class='textCapitalize'>"
						+ items.name
						+ "</td><td><span name='primaryLossEvent' value='" + items.generatedTime + "' class='textCapitalize'>"
						+ items.generatedTime
						+ "</td><td><span name='primaryLossEvent' value='" + items.tranAmount + "' class='textCapitalize'>"
						+ items.tranAmount
						...
						+ items.alertComment
						+ "</td><td><span name='primaryLossEvent' value='" + items.commentBy + "' class='textCapitalize'>"
						+ items.commentBy
						+ "</td>"
						+ "</tr>").appendTo(".romReportTable");
				});
				$("#romReportTable").DataTable({
					"columnDefs": [{
						orderable: false
					}],
					"responsive": false,
					...
					'#romReportTable_wrapper.col-md-6:eq(0)');
...
/*$(document).ready(function() {
	$("#exportAll").click(
		...
		function() {
			...
			tableToExcel('romReportTable', 'Staff And OBST Report', 'Staff And OBST Report');
		}
	);
});*/
